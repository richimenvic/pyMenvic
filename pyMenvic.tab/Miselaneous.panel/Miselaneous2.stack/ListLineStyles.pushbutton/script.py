# -*- coding: utf-8 -*-
__title__  = "List Line Styles"
__author__ = "Ricardo J. Mendieta"

"""
==========================================================
pyMENVIC | LINE STYLE LISTER (Usage + Labels)
Revit + pyRevit

Descripción
-----------
Herramienta para listar todos los Line Styles del proyecto
y mostrar su uso dentro del modelo mediante Detail Lines.

El script crea:
- una línea de muestra para cada estilo
- una etiqueta con el nombre del estilo
- el número de usos detectados en el proyecto
...
------------------------
1. Detecta automáticamente un estilo de texto tipo:
   "Arial 2.5mm" (incluye variantes 2,5 / 2.50 / espacios).
2. Si no existe, solicita al usuario seleccionar un
   TextNoteType desde una interfaz.
3. Cuenta el uso de cada estilo en Detail Lines del
   proyecto completo.
4. Genera una línea de muestra y su etiqueta.
5. Ajusta dimensiones automáticamente según la escala
   de la vista.

Restricciones
-------------
El script no funciona en vistas de tipo Legend.
