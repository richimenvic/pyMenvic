...
--------------------
Para cada nota encontrada se reporta:

- Estilo de texto
- Contenido (preview del texto)
- Vista donde se encuentra
- Plano (Sheet) asociado
- Enlace directo al elemento en Revit

Funciones principales
---------------------
1. Detecta todos los TextNote del proyecto
   (incluyendo vistas de leyenda).
2. Cuenta el uso por tipo de texto.
3. Muestra un menú para seleccionar estilos.
4. Genera una tabla de resultados con links
   directos a cada nota.
5. Permite seleccionar todas las notas
   encontradas directamente en Revit.

Uso típico
----------
Auditoría BIM y limpieza de estilos de texto
en proyectos con muchos tipos de anotaciones.
